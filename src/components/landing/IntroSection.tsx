    ...
    <section id="about" className="bg-white py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-24">
          ...
          >
            <h3 className="text-3xl font-bold text-emerald-950 mb-4 font-heading">
          ...
          >
            {PAIN_POINTS.map((point, index) => (
              <motion.div
                ...
                className="relative group bg-white/70 backdrop-blur-xl border border-emerald-100 p-8 rounded-[2rem] shadow-lg shadow-emerald-500/10 hover:shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 hover:-translate-y-2 overflow-hidden"
              >
                ...
                <div className="relative z-10 w-14 h-14 flex items-center justify-center rounded-2xl bg-emerald-50 mb-6 group-hover:scale-110 group-hover:bg-emerald-100 transition-all duration-300 shadow-sm border border-white">
                  {point.icon}
                </div>
                <h4 className="text-xl font-bold text-emerald-950 mb-3 relative z-10 group-hover:text-emerald-600 transition-colors">{point.title}</h4>
        ...
        <div className="grid gap-6 lg:grid-cols-2 items-stretch">
          ...
          >
            ...
            <div className="relative p-8 sm:p-12 flex-1 flex flex-col z-10 -mt-10">
              ...
              <h3 className="text-3xl font-extrabold mb-4 font-heading tracking-tight">Tầm nhìn <span className="text-emerald-300 font-medium text-xl ml-2 opacity-80">(Vision)</span></h3>
          ...
          <motion.div
            ...
            className="relative bg-gradient-to-br from-emerald-600 via-emerald-500 to-emerald-400 text-emerald-950 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-emerald-500/30 group flex flex-col border border-white/50"
          >
            ...
            <div className="relative p-8 sm:p-12 flex-1 flex flex-col z-10 bg-white/40 backdrop-blur-md border-t border-white/40">
              ...
              <h3 className="text-3xl font-extrabold mb-6 font-heading tracking-tight">Sứ mệnh <span className="text-emerald-950/60 font-medium text-xl ml-2">(Mission)</span></h3>
              <ul className="space-y-5">
                <li className="flex items-start gap-4">
                  <div className="w-2 h-2 rounded-full bg-emerald-900 mt-2 shrink-0 shadow-sm" />
                  <span className="text-emerald-950 font-semibold text-[1.05rem] leading-snug">Giúp sinh viên tiết kiệm chi phí học tập</span>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-2 h-2 rounded-full bg-emerald-900 mt-2 shrink-0 shadow-sm" />
                  <span className="text-emerald-950 font-semibold text-[1.05rem] leading-snug">Tạo môi trường chia sẻ tài nguyên học tập hiệu quả</span>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-2 h-2 rounded-full bg-emerald-900 mt-2 shrink-0 shadow-sm" />
                  <span className="text-emerald-950 font-semibold text-[1.05rem] leading-snug">Góp phần xây dựng cộng đồng sinh viên kết nối – bền vững – hỗ trợ lẫn nhau</span>
                </li>
              </ul>
            </div>
          </motion.div>
