  ...
  return (
    <section id="gallery" className="bg-white py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block py-1 px-3 rounded-full bg-emerald-50 text-emerald-700 text-sm font-semibold tracking-wider uppercase mb-4">
            Hoạt Động Cộng Đồng
          </span>
        ...
        <div className="grid gap-6 md:grid-cols-12 md:grid-rows-2 h-auto md:h-[600px]">
          <motion.article
            ...
            className="group relative overflow-hidden rounded-3xl md:col-span-8 md:row-span-2 shadow-lg shadow-emerald-500/10"
          >
            <div className="absolute inset-0 bg-emerald-950/10 transition-colors group-hover:bg-transparent z-10" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 z-20 translate-y-4 opacity-90 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
              <span className="inline-block rounded-full bg-emerald-500/90 px-3 py-1 text-xs font-bold text-white backdrop-blur-sm mb-3">
                Trao đổi sôi nổi
              </span>
          ...
          <motion.article
            ...
            className="group relative overflow-hidden rounded-3xl md:col-span-4 md:row-span-2 shadow-lg shadow-emerald-500/10 min-h-[300px]"
          >
            <div className="absolute inset-0 bg-emerald-950/10 transition-colors group-hover:bg-transparent z-10" />
            <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/80 via-emerald-950/20 to-transparent z-10" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 z-20 translate-y-4 opacity-90 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
              <span className="inline-block rounded-full bg-emerald-600/90 px-3 py-1 text-xs font-bold text-emerald-950 backdrop-blur-sm mb-3">
                Kết nối sinh viên
              </span>
